...
{
    /// <inheritdoc />
    public partial class M202606241120InitialDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagTasks", x => new { x.TagId, x.TaskId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerContacts_Type_Value_CustomerId",
                table: "CustomerContacts",
                columns: new[] { "Type", "Value", "CustomerId" },
                unique: true);
